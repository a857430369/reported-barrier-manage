          ...
          layim.config({
            ...
            init: {
              ...
              mine: {
                ...
                id: 123, //我的ID
                avatar:
                  'http://tvax1.sinaimg.cn/crop.0.0.300.300.180/006Iv8Wjly8ff7ghbigcij308c08ct8i.jpg', //我的头像
                sign: '懒得签名'
              },
              //我的好友列表
              friend: [
          ...
          */
          ...
          layim.on('detail', function(data) {
            ...
            layim.panel({
              ...
              tpl:
                '<div style="padding: 10px;">自定义模版，<a href="http://www.layui.com/doc/modules/layim_mobile.html#ondetail" target="_blank">参考文档</a></div>', //模版
              data: {
                //数据
                test: '么么哒'
              }
          ...
          setTimeout(function() {
            layim.getMessage({
              ...
              // avatar: 'http://tp1.sinaimg.cn/1571889140/180/40030060651/1',
              avatar:
                'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1587532239400&di=bb7ac40dda7632dc8ab3ed0ce0770090&imgtype=0&src=http%3A%2F%2F5b0988e595225.cdn.sohucs.com%2Fimages%2F20181003%2F0f8307fe3de6468d8b51c53b276e9e1b.jpeg',
              id: '100001',
              type: 'friend',
              cid: (Math.random() * 100000) | 0, //模拟消息id，会赋值在li的data-cid上，以便完成一些消息的操作（如撤回），可不填
              content: '在不在,在不在,重要的事说三遍 face[白眼]'
            })
          }, 3000)
