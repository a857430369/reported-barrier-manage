<template>
  <div class="el-transfer-panel"
    ...
    <div :class="['el-transfer-panel__body', hasFooter ? 'is-with-footer' : '']" v-loading="loading">
      ...
      <el-row>
        <el-col :span="18" class="userName-input">
      <el-input class="el-transfer-panel__filter"
        ...
        <el-col :span="4" style="line-height: 62px">
      ...
      <el-checkbox-group v-model="checked"
        ...
        <el-checkbox class="el-transfer-panel__item"
          ...
          {{ item[labelProp] + (item['EMP_SMS'] ? ' (' + item['EMP_SMS'] + ')' : '') }}
        </el-checkbox>
      </el-checkbox-group>
      ...
      this.loading = true
       ...
       if (this.query && this.query != "") {
        if (this.isFar) {
          ...
          this.$api.notice.findUserAndPhone(params).then(res => {
           this.loading = false
          ...
          this.filteredData = this.data.filter(item => {
            return item.USER_NAME.indexOf(this.query) != -1;
          });
        }
