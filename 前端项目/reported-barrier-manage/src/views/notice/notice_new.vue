  ...
  <div style="margin:0 auto;width:90%">
    <div>
      ...
      <h1 style="margin:20px auto;text-align:center">
        {{ this.message.noticeName }}
        <span style="text-align:center;color:red">{{
          this.message.noticeUrgent == 'J' ? '(紧急通知)' : ''
        }}</span>
      </h1>
    </div>
    ...
    <div id="app" style="margin:15px auto">
      ...
      <el-row>
        <el-form v-if="play" label-width="55px">
          ...
          >
            <el-button type="text" class="button" @click="Download(o)">{{
              o.fileName
  ...
  methods: {
    ...
    handleSure() {
      if (this.message.value == '0') {
        ...
        let dev = {
          noticeCode: this.message.noticeCode,
          noticeAppoint: this.message.noticeAppoint,
        }
