<template>
  <div class="custom_style" style="height: 100%">
    <el-container style="height: 100%">
      <!-- 侧边导航栏 -->
      <el-card  :style="{ 'height':screenHeight - 20 +'px', margin: '10px auto',width: '280px'}" v-if="MenuData.length !== 0">
        <!-- 导航栏数据 -->
        <div :style="{ height: screenHeight-70 + 'px'}" v-if="isCollapse">
          ...
          <h2 class="allFile" style="text-align: center;margin-bottom: 10px">
            ...
            @click="handleHeaderFile"><span>全部文件</span>
            </span>
          </h2>
      ...
      <el-form ref="ruleForm" :rules="rules" :model="form">
        ...
        <el-form-item  prop="menuCode" >
            <el-cascader
              ...
              :props="{ expandTrigger: 'hover',checkStrictly: true, value:'menuCode', label:'menuName' }">
