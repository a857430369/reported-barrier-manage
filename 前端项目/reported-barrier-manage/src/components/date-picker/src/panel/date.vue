      ...
      <div class="el-picker-panel__body-wrapper">
        <div class="el-picker-panel__body">
          ...
          <div
            ...
            <span class="custom-arrow-all custom-arrow-left" @click="prevMonth">
            ...
            <span
              ...
              role="button"
              class="custom-year-date el-date-picker__header-label orange-date"
              :class="{ active: currentView === 'month' }">{{ getEngtherMonth(month + 1)}}</span>
            <span
              role="button"
              class="el-date-picker__header-label alert orange-date custom-year-date">{{ yearLabel }}</span>

            <span class="custom-arrow-all custom-arrow-right" @click="nextMonth">
          ...
          <!-- 下面的日历 -->
          <div class="el-picker-panel__content" style="margin: 10px">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
