<template>
  <table
    ...
    <tr style="line-height: 12px">
      ...
      <th class="date-week-color" v-for="(week, key) in WEEKS" :key="key">{{ week }}</th>
    </tr>
    <tr
      ...
      <td
        ...
        :key="key">
        <div style="height: 21px;box-size: boder-content">
          <span style="height: 19px;line-height: 19px">
            {{ cell.text }}
          </span>
        </div>
      </td>
...
.el-date-table .custom-today:hover {
  color: #fff;
}
</style>
